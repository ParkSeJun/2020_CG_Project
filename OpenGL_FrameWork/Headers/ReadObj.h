...
bool ReadObj(const char* objFileName, _float*& vPosOut, _float*& vNormalOut, _float*& vTextureCoordinateOut, _uint*& indexOut, _uint& vertexCount, _uint& indexCount)
{
    ...
    vPosOut = new _float[vertexCount * 3];
    vNormalOut = new _float[vertexCount * 3];
    vTextureCoordinateOut = new _float[vertexCount * 2];
    indexOut = new _uint[indexCount];
